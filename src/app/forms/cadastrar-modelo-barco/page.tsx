...
const CadastrarModelo = () => {
    ...
    const { register, handleSubmit, control, reset, formState: { errors } } = useForm<ModeloBarcoForm>({
        resolver: zodResolver(modeloBarcoSchema)
    })
        ...
        const submit = async (data: any) => {
            ...
            try {
                ...
                await httpClient.post(`${baseUrl}/resources/modelo`, data, token || "")

                openModal("Sucesso!", "Modelo de barco cadastrado com sucesso!", [{ type: "bg-primary", text: "Ok" }])
                reset()
            } catch (error: any) {
                let errorMessage
    ...
    return (
        <DefaultLayout>
            <Breadcrumb pageName="Cadastrar novo modelo de barco" />
                    ...
                    <div className="flex flex-col gap-9">
                        ...
                        <FormCard title="Informações">
                            <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                ...
                                <div className=" xl:w-1/2 w-full ">
                                    <InputElement register={register} registerName="modelo" label="Modelo" placeholder="Nome do modelo" errorMessage={errors.modelo?.message} />
                                </div>
                            </div>
