...
export const seminovoSchema = z.object({
    ...
    imagens: z.array(z.object({filename: z.string(textMessage), path: z.string(textMessage)}), {message: "Erro na estrura de dados das imagens"}).min(numeroMinimoImagens, {message: `Adicione pelo menos ${numeroMinimoImagens} imagens para seu barco.`}),
